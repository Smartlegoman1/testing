...
module.exports = class extends BaseCommand {
    constructor() {
        super({
            config: {
                name: 'terms',
                description: 'Read Oha\'s Terms of Service.',
                permission: 'User',
            },
            options: {
                cooldown: 3,
    ...
    async run(client, message, args) {
        return message.channel.send(new Discord.MessageEmbed()
            .setColor(0x00FFFF)
            .setTitle(`Oha Bot - Terms of Service`)
            .setDescription('\Oha has access to the End User Data through the Discord API, but Oha does not collect, use and/or disclose End User Data except (a) as necessary to exercise your rights under this Agreement, (b) in accordance with Discord’s Privacy Policy.' +
                ...
                '\n\nBy using Oha you expressly agree to this Agreement. And by using Discord you expressly agree to Discord’s [Terms of Service](https://discordapp.com/terms), [Guidelines](https://discordapp.com/guidelines) and [Privacy Policy](https://discordapp.com/privacy).' +
